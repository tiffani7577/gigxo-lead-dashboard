...
import AdminDjOutreach from "./pages/AdminDjOutreach";
...
import AdminAVRequests from "./pages/AdminAVRequests";
...
import MiamiPride2026 from "./pages/blog/MiamiPride2026";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/admin/dj-outreach" component={AdminDjOutreach} />
      ...
      <Route path="/blog/miami-pride-2026" component={MiamiPride2026} />
